...
export default function AppLayout({ children, user, title }: Props) {
    ...
    const allNavItems = [
        { href: '/dashboard', label: 'Dashboard', icon: LayoutIcon, permission: 'view_dashboard' },
        { href: '/transactions', label: 'Transactions', icon: ArrowsIcon, permission: 'list_transactions' },
        { href: '/networks', label: 'Networks', icon: ServerIcon, permission: 'list_networks' },
